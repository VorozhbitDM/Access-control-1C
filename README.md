...
<a href="https://github.com/VorozhbitDM/Access-control-1C/releases">
    <img src="https://img.shields.io/badge/Download-v4.7-Grey?style=for-the-badge&logo=github&labelColor=696969&color=1E90FF" alt="Download">
  </a>
...
<details>
 <summary><strong style="font-size: 1.7em;"> 💡 Новое в версии 4.7:</strong></summary>
<br>

- ✅ **Выбор конфигурации** — при первом запуске обработка предлагает подтвердить автоматически определённую конфигурацию или указать другую. Тот же выбор доступен в **«Настройках программы»**. Список включает УТ, КА, ERP, БП, ЗУП, УНФ, Документооборот 3.0 и «Другую конфигурацию»; поддержка остальных конфигураций будет расширяться. **Стабильная работа** по-прежнему гарантирована только на изначально заявленных конфигурациях (см. таблицу совместимости ниже).
...
- ✅ **Исправлено сравнение ролей** — снова работает с главной формы и из формы «Копирование / Сравнение».
- ✅ **Исправлена очистка пользовательских настроек** — в разделе управления настройками пользователя.
...
![image](https://github.com/VorozhbitDM/Access-control-1C/assets/170056560/a2553ae5-24d9-4717-9979-dfd71e2660b0)
 ...
 ## Настройки программы
  ...
  + **Конфигурация информационной базы** — выбор или смена конфигурации для корректной работы обработки (с v4.7).
...
> С **v4.7** в настройках можно указать и другие конфигурации (БП, ЗУП, УНФ, Документооборот 3.0, «Другая»). Полноценная поддержка для них будет добавляться постепенно; на текущий момент **стабильная работа** гарантирована только для конфигураций из таблицы выше.
