...
- ✅ **Добавить роль в существующий профиль** — в контекстном меню таблицы ролей выбранного объекта: выбор уже имеющегося профиля групп доступа и добавление в него найденной роли. Если роль уже входит в профиль или запись недоступна — выводится понятное сообщение. После успешного добавления обновляется список групп и профилей по роли.
...
- Версия обработки и регистрационные данные: **v4.9**.
- Скриншоты: `docs/images/v4.9/`.

## 4.8 (2026-06-27)

### Исправлено

- ✅ **Сравнение прав пользователей** — исправлен неполный список групп, профилей и ролей: учтён вход через группы пользователей.

### Техническое

- Версия обработки и регистрационные данные: **v4.8**.
...
Подробнее — в разделе [Отчёты по ролям](DOCS.md#doc-role-reports) документации.
...
Чтобы сравнить **любые** роли конфигурации без привязки к объекту: **«Копирование / Сравнение / Настройки»** → вкладка **«Сравнение ролей»** → выбор ролей → **«Сравнить»** (подробнее в разделе [Сравнение ролей](DOCS.md#doc-compare-roles) документации).
